...
| **Stockage**         | ![Supabase](https://shieldcn.dev/badge/Supabase-Postgres-3ECF8E.svg) tokens OAuth et historique des playlists, RLS activé, accès avec la clé `service_role` |
